...
public class SampleClientImpl implements SampleClient {
    ...
    @Override
    public CompletableFuture<String> postUser(User user) throws ResourceException {
        String path = "/users";
        String body = null;
    ...
    @Override
    public CompletableFuture<String> putUser(int id, User user) throws ResourceException {
        String path = "/users/{id}";
        String body = null;
        ...
        URI uri = UriBuilder.fromUri(url).path(path)
                            .resolveTemplate("id", id)
                            .build();
        ParsecAsyncHttpRequest request = getRequest("PUT", uri, body);
